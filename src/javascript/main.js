...
$("#explainButton").click(function(){
    $("html, body").animate({scrollTop: $("#explain").offset().top},1200);
    })

//Scrolování na sekci O mně
$("#myselfButton").click(function(){
    $("html, body").animate({scrollTop: $("#myself").offset().top},1200);
    })
    ...
    $("#Aexplain").click(function(){
        if(window.location.href == 'http://127.0.0.1:5500/src/index.html#')  {
            $("html, body").animate({scrollTop: $("#explain").offset().top},1200); // Plynulý scroll
        }
        else {
    ...
    $("#Amyself").click(function(){
        if(window.location.href == 'http://127.0.0.1:5500/src/myself.html#')  {
            $("html, body").animate({scrollTop: $("#myself").offset().top},1200); // Plynulý scroll
        }
        else {
            window.location.href = 'http://127.0.0.1:5500/src/myself.html#';
        }
    });
